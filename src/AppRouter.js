...
function AppRouter() {
    return (
        <Switch>
            ...
            <PrivateRoute exact path='/manage-quota/:zone_id' component={ManageQuota} />
            <PrivateRoute exact path="/vaccine-center" component={VaccineCenter} />
            <PrivateRoute exact path="/manage-zone" component={ManageZone} />
            <PrivateRoute exact path="/vaccine-center/:zoneId/detail/:centerId" component={VaccineCenterDetail} />
        </Switch>
    );
}
